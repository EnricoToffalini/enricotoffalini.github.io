...
**Short description**  
Short (10-hour) PhD-level introductory course on Python for data science. The idea is to give learners (who ideally already use R) a practical entry point into Python, with a focus on tools that R does not cover as easily.
