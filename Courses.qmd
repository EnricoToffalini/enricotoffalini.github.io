...
<details>
<summary><p style="font-size:25px;">Basics of R for Data Science ![English](images/english.png){width=18px}</p></summary>
<br>
...
<summary><p style="font-size:25px;">
  Basics of Python for Data Science ![English](images/english.png){width=18px} </p>
</summary>
