...
**Short description**  
Introductory, hands-on course on R for data science. The focus is on using R as a practical tool for data handling, visualization, and basic statistical modeling, with a strong emphasis on reproducible workflows.
...
**Short description**  
Short (10-hour) PhD-level introductory course on Python for data science. The idea is to give students (who ideally already use R) a practical entry point into Python, with a focus on tools that R does not cover as easily.
